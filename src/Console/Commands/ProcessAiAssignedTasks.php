...
class ProcessAiAssignedTasks extends Command
{
    ...
    private function buildAgentMessages(PlannerTask $task, User $aiUser, ?int $fallbackUserId): array
    {
        ...
        $system = "Du bist ein AI-User innerhalb einer Plattform.\n"
            ...
            . "WICHTIG (Tool-Discovery wie im Playground):\n"
            . "- Du siehst anfangs nur Discovery-Tools (z.B. tools.GET, core.teams.GET).\n"
            . "- Wenn dir ein Tool fehlt (z.B. planner.tasks.PUT), musst du es erst per tools.GET nachladen.\n"
            . "  Beispiel: tools.GET {\"module\":\"planner\",\"search\":\"tasks.PUT\"}\n\n"
