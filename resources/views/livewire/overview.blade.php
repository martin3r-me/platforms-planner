        ...
        <div>
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-16">
                ...
                <div class="mt-10 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-9">
                    ...
                    <div class="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-gray-200 text-sm shadow-sm ring-1 ring-gray-200 dark:bg-white/15 dark:shadow-none dark:ring-white/15">
                        @foreach($calendarData['days'] as $index => $day)
                            ...
                            >
                                ...
                                @if($day['taskCount'] > 0 && $isCurrentMonth)
                                    <span class="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-indigo-600 text-[10px] font-semibold text-white">
                                        {{ $day['taskCount'] }}
                                    </span>
                                @endif
                            </button>
                    ...
                    <button 
                        type="button" 
                        onclick="window.location.href='{{ route('planner.my-tasks') }}'"
