    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $slotsStructure = $slots->map(function($slot) {
                ...
                $tasksOpen = $slot->tasks()->where('lifecycle_state', TaskLifecycleState::ACTIVE->value)->count();
                $tasksDone = $slot->tasks()->where('lifecycle_state', TaskLifecycleState::COMPLETED->value)->count();
